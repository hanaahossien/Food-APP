...
import { axiosInstance, recipi } from "../../../../services/apiUrls/apiUrl";
...
export default function RecipeForm() {
  ...
  const onSubmit = async (data) => {
    ...
    console.log(formdat);
    try {
      const res =await axiosInstance[paramId == undefined ? "post" : "put"](
        paramId == undefined ? recipi.addRecpi : recipi.updateRecipi(paramId),
        formdat
      );
      getCategoriesList()
  ...
  useEffect(() => {
    ...
    if (paramId != undefined) {
      ...
      let getRecipe = async () => {
        let response = await axiosInstance.get(recipi.geRecpi(paramId));
